...
public class Pet_Operators {
	...
	public static void main(String[] args) {
		...
		System.out.println("Combined Pet Limbs are : "+ combinedLimbs);
		...
		System.out.println("My fishes weight: "+fishWeightKg+" kg [Using Division] and "+fishWeightGrams+" grams [Using Modulus]");
		...
		*/
		...
		System.out.println(" Is combined weight of pets not greater than 10 ? " + isFishLessThanKilo);
